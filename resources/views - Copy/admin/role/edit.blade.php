...
@section('content')
    ...
    <form action="{{ route('admin.role.update', ['id' => $roleInfo->id]) }}" method="post">
        @csrf
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <input class="form-control" name="role_name" type="text" value="{{ $roleInfo->role_name ?? '' }}" aria-label="default input example" />
