        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.faq.index') }}"><i
                                class="bx bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('admin.faq.index') }}">Category Pages</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        ...
                        <form action="{{ route('admin.faq.update', $record->id) }}" method="POST"
