    ...
    <table class="table align-middle" style="background-color:#8e8e8">
        <thead class="table-secondary">
            <tr>
                ...
                @endforeach
                <th class="no-wrap"> @sortablelink('is_published', 'Status')</th>
                ...
                <tr data-id="{{ $item->id }}" class="sortable-row">
                    ...
                    <td>
                        <span
                            ...
                            onclick="changeStatus(event,{{ $item->id }})">{{ ucfirst($item->is_published == 1 ? 'Published' : 'UnPublished') }}
                        </span>
                    </td>

                    <td>
                        <div class="table-actions d-flex align-items-center gap-3 fs-6">
                            <a href="{{ route('admin.faq.view', ['id' => $item->id]) }}"
                            ...
                            <a href="{{ route('admin.faq.edit', ['id' => $item->id]) }}" class="text-warning"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i
                                    class="fa-solid fa-pen-to-square text-warning fs-5"></i></a>

                            <a href="javascript:void(0);"
                                onclick="deleteItem('{{ route('admin.faq.delete', ['id' => $item->id]) }}')"
