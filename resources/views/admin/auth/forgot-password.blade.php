        ...
        <div class="card border shadow-sm rounded-3">
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    @csrf
                    <div class="form-floating text-secondary mb-5 mt-4">
                        <input type="email" name="email" value="{{ old('email') }}" required
                            class="form-control" id="floatingInput" placeholder="Enter email">
                    ...
                    <button type="submit" class="btn btn-primary py-2 mt-4 w-100">
