    ...
    <table class="table align-middle" style="background-color:#8e8e8">
        <thead class="table-secondary">
            <tr>
                ...
                <th class="no-wrap">Full Name</th>
                <th class="no-wrap">Email</th>
                <th class="no-wrap">Mobile</th>
                ...
                <tr class="">
                    ...
                    <td>
                        <div class="table-actions d-flex align-items-center gap-3 fs-6">
                            <a href="{{ route('admin.contact.view', ['id' => $item->id]) }}"
                            ...
                            {{-- <a href="{{ route('admin.contact.edit', ['id' => $item->id]) }}" class="text-warning"
                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i
                                    class="fa-solid fa-pen-to-square text-warning fs-5"></i></a> --}}

                            <a href="javascript:void(0);"
                                onclick="deleteItem('{{ route('admin.contact.delete', ['id' => $item->id]) }}')"
