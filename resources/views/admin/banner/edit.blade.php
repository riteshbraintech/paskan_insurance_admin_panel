        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.banner.index') }}">Category Pages</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Banner Page</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        ...
                        <form action="{{ route('admin.banner.update', $record->id) }}" method="POST"
