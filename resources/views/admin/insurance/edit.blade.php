...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Edit Insurance</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.insurances.index') }}"><i
                                class="bx bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('admin.insurances.index') }}">Category Pages</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Insurance Page</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        ...
                        <form action="{{ route('admin.insurances.update', $record->id) }}" method="POST"
