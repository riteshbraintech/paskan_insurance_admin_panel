...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">All Insurances</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.categories.index') }}">Insurance Page</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All Insurances</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.categories.create') }}">
                    <a href="{{ route('admin.insurances.create') }}" class="btn btn-primary">+ Add Insurance</a>
                </a>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        function changeStatus(event, id) {
            let url = "{{ route('admin.insurances.change.status') }}" + "/" + id;
            $.ajax({
                url: url,
                type: "post",
                data: {
