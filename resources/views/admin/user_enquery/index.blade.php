            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.categories.index') }}">User Enquery Page</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All User Enquery</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <div class="load-table-data">
                    @include('admin.user_enquery.table')
                </div>
            </div>
        </div>
    </div>
