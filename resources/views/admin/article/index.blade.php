...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">All Articles</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.article.index') }}">Article Page</a></li>
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.article.create') }}">
                    <a href="{{ route('admin.article.create') }}" class="btn btn-primary">+ Add Article</a>
                </a>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        function changeStatus(event, id) {
            let url = "{{ route('admin.article.change.status') }}" + "/" + id;
            $.ajax({
                url: url,
                type: "post",
                data: {
